...
class TestNeuralWBCEnvCfgTaksT1(unittest.TestCase):
    def setUp(self):
        ...
        self.env_cfg = NeuralWBCEnvCfgTaksT1()
    ...
    def test_load_config(self):
        loaded_cfg = NeuralWBCEnvCfgTaksT1()
        loaded_cfg.load(self.temp_file_name)
        self.assertTrue(compare_configs(self.env_cfg, loaded_cfg))

    def test_action_space(self):
        # Taks_T1 has 32 DOF
        self.assertEqual(self.env_cfg.action_space, 32)

    def test_joint_names(self):
        # Verify all 32 joints are defined
        self.assertEqual(len(self.env_cfg.joint_names), 32)

    def test_body_names(self):
        # Verify all 33 bodies are defined
        self.assertEqual(len(self.env_cfg.body_names), 33)
