...
"""Test termination conditions with Taks_T1 robot model."""
...
class TestTerminationConditionsTaksT1(unittest.TestCase):
    """Test termination conditions with Taks_T1 robot model."""
    ...
    def test_taks_t1_specific_body_count(self):
        """Test that Taks_T1 specific body count is correct."""
        self.assertEqual(self.num_bodies, 33)
        self.assertEqual(self.num_joints, 32)
