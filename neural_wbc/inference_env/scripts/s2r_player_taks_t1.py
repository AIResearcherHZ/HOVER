...
# Note: You need to create a TaksT1 robot wrapper similar to UnitreeH1
# from hw_wrappers.taks_t1 import TaksT1  # noqa
from inference_env.deployment_player import DeploymentPlayer
from inference_env.neural_wbc_env_cfg_real_taks_t1 import NeuralWBCEnvCfgRealTaksT1
from inference_env.utils import get_player_args

from neural_wbc.data import get_data_path

parser = get_player_args(description="Basic deployment player for running HOVER policy on real Taks_T1 robot.")
...
def main():
    ...
    env_cfg = NeuralWBCEnvCfgRealTaksT1(model_xml_path=get_data_path("mujoco/models/Taks_T1/scene_Taks_T1.xml"))
    ...
    print("Deploying policy on real Taks_T1 robot.")
