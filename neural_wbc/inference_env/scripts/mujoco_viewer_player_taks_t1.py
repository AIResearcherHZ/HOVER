...
parser = get_player_args(description="Evaluates motion tracking policy and collects metrics in MuJoCo for Taks_T1.")
...
def main():
    ...
    player = DeploymentPlayer(
        args_cli=args_cli,
        env_cfg=NeuralWBCEnvCfgTaksT1(model_xml_path=get_data_path("mujoco/models/Taks_T1/scene_Taks_T1.xml")),
